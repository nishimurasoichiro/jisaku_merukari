...
<div class="container">
        ...
        <div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="word" aria-describedby="emailHelp" name = 'word' placeholder="検索ワードを入れてください">
            </div>
                    ...
                    <div class="card-footer" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            @auth
                                ...
                                @else
                                <p class="favorite-marke">
                                <a class="js-like-toggle" href="" data-itemid="{{ $item->id }}">いいねじゃないよ</a>
                                <span class="likesCount">{{$item->likes_count}}</span>
                                </p>
                                @endif
                            ...
                            <script>
                                $(function () {
                                    ...
                                    // console.log(data);
                                    if(data.like_flg == 0){
                                        $(".js-like-toggle").text("いいねじゃないよ");
                                    }else{
                                        $(".js-like-toggle").text("いいね済み");
                                    }
